...
const features = [
          ...
          <BlurIn duration={0.5} className="h-full">
            <Image
              ...
              src={
                ...
                "https://github.com/bjornleonhenry.png"
              }
              alt="avatar image"
              width={200}
              height={200}
  ...
  },
  {
    ...
    name: "Technologies",
    description:
      "Using a combination of time-tested and cutting-edge modern technologies to build optimize and deploy scalable, robust, and secure full-stack applications.",
    href: "/technologies",
  ...
  },
  {
    ...
    description: "Push, build, deploy, and repeat.",
    className: "col-span-3 md:col-span-1",
